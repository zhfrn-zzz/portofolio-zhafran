    ...
    return (
        ...
        <div className="p-6 space-y-6">
            ...
            <form onSubmit={handleCommentSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <textarea
                        ...
                        className="w-full p-4 rounded-xl bg-white/5 border border-white/10
                                 text-white placeholder-gray-400 focus:outline-none focus:border-indigo-500
                                 focus:ring-2 focus:ring-indigo-500/20 transition-all resize-none min-h-[120px]"
                        required
                    />
                </div>

                {/* Profile Photo Input with Label */}
                <div className="space-y-2">
                    <label className="block text-sm font-medium text-white">
                        ...
                        {imagePreview ? (
                            <div className="flex items-center gap-4">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 rounded-full bg-red-500/20
                                             text-red-400 hover:bg-red-500/30 transition-all group"
                                >
                                    <X className="w-4 h-4" />
                            ...
                            <div className="w-full">
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl
                                             ...
                                             transition-all border border-dashed border-indigo-500/50
                ...
                >
                    <div className="absolute inset-0 bg-white/20 translate-y-12 group-hover:translate-y-0
                        ...
                        comments.map((comment) => (
                            <div
                                ...
                                className="p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10
                                         transition-all group hover:shadow-lg hover:-translate-y-0.5"
                            >
