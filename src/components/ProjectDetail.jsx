    ...
    <div className="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4 bg-[#0a0a1a] rounded-xl overflow-hidden relative">
      ...
      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/5 p-2 md:p-3 rounded-lg border border-blue-500/20 transition-all duration-300 hover:scale-105 hover:border-blue-500/50 hover:shadow-lg">
        ...
        <div className="flex-grow">
          ...
          <div className="text-[10px] md:text-xs text-gray-400"><TransText k="project.stats.totalTech" fallback="Total Teknologi" /></div>
        </div>
      </div>
      ...
      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/5 p-2 md:p-3 rounded-lg border dark:border-purple-500/20 border-[var(--accent)]/20 transition-all duration-300 hover:scale-105 hover:dark:border-purple-500/50 hover:border-[var(--accent)]/50 hover:shadow-lg">
        ...
        <div className="flex-grow">
          ...
          <div className="text-[10px] md:text-xs text-gray-400"><TransText k="project.features" fallback="Fitur Utama" /></div>
        </div>
      </div>
    </div>
  );
...
const handleGithubClick = (githubLink, t) => {
  if (githubLink === 'Private') {
    Swal.fire({
      icon: 'info',
  title: t ? t('project.privateRepo.title', 'Private Source Code') : 'Private Source Code',
  text: t ? t('project.privateRepo.text', 'Sorry, the source code for this project is private.') : 'Sorry, the source code for this project is private.',
  confirmButtonText: t ? t('project.privateRepo.confirm', 'Understood') : 'OK',
    ...
    return (
      <div className="min-h-screen dark:bg-[#030014] bg-[var(--bg)] flex items-center justify-center">
        <div className="text-center space-y-6 animate-fadeIn">
          ...
          <h2 className="text-xl md:text-3xl font-bold text-white"><TransText k="project.loading" fallback="Memuat Proyek..." /></h2>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen dark:bg-[#030014] bg-[var(--bg)] px-[2%] sm:px-0 relative overflow-hidden">
      ...
      <div className="relative">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          <div className="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fadeIn">
            ...
            >
              ...
              <span><TransText k="project.back" fallback="Kembali" /></span>
            </button>
            <div className="flex items-center space-x-1 md:space-x-2 text-sm md:text-base text-white/50">
              <span><TransText k="project.breadcrumbProjects" fallback="Proyek" /></span>
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                >
                  ...
                  <span className="relative font-medium"><TransText k="project.liveDemo" fallback="Demo Langsung" /></span>
                </a>
                ...
                >
                  ...
                  <span className="relative font-medium"><TransText k="project.github" fallback="GitHub" /></span>
                </a>
              </div>
              ...
              <div className="space-y-4 md:space-y-6">
                <h3 className="text-lg md:text-xl font-semibold text-white/90 mt-[3rem] md:mt-0 flex items-center gap-2 md:gap-3">
                  ...
                  <TransText k="project.techUsed" fallback="Teknologi yang Digunakan" />
                </h3>
                {project.TechStack.length > 0 ? (
                  ...
                  <p className="text-sm md:text-base text-gray-400 opacity-50"><TransText k="project.noTech" fallback="Belum ada teknologi ditambahkan." /></p>
                )}
              </div>
            </div>
        ...
        {/* Fitur Utama */}
          ...
          <TransText k="project.features" fallback="Fitur Utama" />
                </h3>
          ...
          <p className="text-gray-400 opacity-50"><TransText k="project.noFeatures" fallback="Belum ada fitur ditambahkan." /></p>
                )}
              </div>
            </div>
          </div>
