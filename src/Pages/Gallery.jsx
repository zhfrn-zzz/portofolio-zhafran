  ...
  <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] overflow-hidden" id="Gallery">
      <div className="text-center pb-8" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text dark:bg-gradient-to-r dark:from-[#6366f1] dark:to-[#a855f7] bg-gradient-to-r from-[var(--text)] via-[var(--muted)] to-[var(--accent)]">
          <TransText k="gallery.title" fallback="Galeri" className="text-transparent bg-clip-text dark:bg-gradient-to-r dark:from-[#6366f1] dark:to-[#a855f7] bg-gradient-to-r from-[var(--text)] via-[var(--muted)] to-[var(--accent)]" />
        </h2>
        <p className="dark:text-slate-400 text-lighttext/80 max-w-2xl mx-auto text-sm md:text-base mt-2">
          <TransText k="gallery.description" fallback="Koleksi foto dengan ratio 9:16, 16:9, dan 1:1. Klik untuk preview dan lihat deskripsi." />
        </p>
      </div>
      ...
      <Box sx={{ width: "100%" }}>
        ...
        if (list.length === 0) {
          ...
          <p className="text-lg md:text-xl dark:text-gray-300 text-lighttext/80"><TransText k="gallery.comingSoon" fallback="Segera hadir" /></p>
                        </div>
                      );
                    }
                        ...
                        {(() => {
                          ...
                          return (
                            <motion.img
                              ...
                              src={item.image_url}
                              alt={item.description || (useI18n().t('gallery.alt.galleryImage', 'Gambar galeri'))}
                  ...
                  <div className="mt-6 w-full flex justify-start px-[5%]">
                    ...
                    >
                      <span className="relative z-10 flex items-center gap-2">
                        {showAll ? (useI18n().t('gallery.less', 'Lihat Lebih Sedikit')) : (useI18n().t('gallery.more', 'Lihat lebih banyak...'))}
                      </span>
          ...
          >
            ...
            >
              ...
              <motion.img
                ...
                alt={selected.description || (useI18n().t('gallery.alt.selectedImage', 'Gambar terpilih'))}
