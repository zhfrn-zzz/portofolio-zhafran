  ...
  <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] overflow-hidden" id="Portofolio" style={{ contentVisibility: 'auto', containIntrinsicSize: '1200px' }}>
      ...
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="text-3xl md:text-5xl font-bold text-center mb-3">
          <TransText k="portfolio.title" fallback="Portofolio" />
        </h2>
        <p className="text-center text-gray-400 mb-8">
          <TransText k="portfolio.subtitle" fallback="Jelajahi perjalanan saya melalui proyek, sertifikat, dan keahlian teknis." />
        </p>
      </div>
      ...
      <Box sx={{ width: "100%" }}>
        ...
        >
          ...
          >
            <Tab icon={<Code className="mb-2 w-5 h-5 transition-all duration-300" />} label={<TransText k="portfolio.tabs.projects" fallback="Proyek" />} {...a11yProps(0)} />
            <Tab icon={<Award className="mb-2 w-5 h-5 transition-all duration-300" />} label={<TransText k="portfolio.tabs.certificates" fallback="Sertifikat" />} {...a11yProps(1)} />
            ...
            <div className="container mx-auto flex justify-center items-center overflow-hidden">
              {projects.length === 0 ? (
                <div className="py-10 text-center w-full">
                  <p className="text-lg md:text-xl dark:text-gray-300 text-lighttext/80">
                    <TransText k="portfolio.comingSoon" fallback="Segera hadir" />
                  </p>
                </div>
              ) : (
